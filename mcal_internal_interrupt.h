 ...
 * Author: ashra
 *
 * Created on 27 October 2022, 22:34
 */
...
#define MSSP_I2C_BusCollision_InterruptDisable()    (PIE2bits.BCLIE = 0)

#define MSSP_I2C_InterruptEnable()          (PIE1bits.SSPIE = 1)
#define MSSP_I2C_BusCollision_InterruptEnable()    (PIE2bits.BCLIE = 1)

#define MSSP_I2C_InterruptFlagClear()       (PIR1bits.SSPIF = 0)
#define MSSP_I2C_BusCollision_InterruptFlagClear()    (PIR2bits.BCLIF = 0)

#if INTERRUPT_PRIORITY_LEVELS_ENABLE==INTERRUPT_FEATURE_ENABLE 
#define MSSP_I2C_HighPrioritySet()          (IPR1bits.SSPIP = 1)
#define MSSP_I2C_BusCollision_HighPrioritySet()          (IPR2bits.BCLIP = 1)

#define MSSP_I2C_LowPrioritySet()           (IPR1bits.SSPIP = 0)
#define MSSP_I2C_BusCollision_LowPrioritySet()           (IPR2bits.BCLIP = 0)
